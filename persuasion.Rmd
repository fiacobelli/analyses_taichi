...
```
Is the need to excercise post chat significantly higher than the need to excercise pre chat?
```{r}
...
t.test(raw_merged$taichi_learn, raw_merged$taichi_interest, alternative = "greater")
```
...
```{r}
t.test(aerobic$post_excercise_need, aerobic$excercise_need, alternative = "greater")
```

- Did the need to exercise decrease for people who do anaerobic exercise?

```{r}
t.test(anaerobic$post_excercise_need, anaerobic$excercise_need, alternative = "greater")
```

- Did the need to exercise decrease for people who do flexibility exercise?

```{r}
t.test(flexibility$post_excercise_need, flexibility$excercise_need, alternative = "greater")
```
